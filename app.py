...
with tab1:
    ...
    with st.form("daily_log", clear_on_submit=False, enter_to_submit=False):
        ...
        anything_else = st.text_area(
            "Anything else?",
            placeholder="Notes about mood, stress, illness, travel, period, etc.",
        )
        week_notes = st.text_area(
            "Other important notes from this week",
            placeholder="Anything that may have affected how you felt that was not the medication.",
        )
